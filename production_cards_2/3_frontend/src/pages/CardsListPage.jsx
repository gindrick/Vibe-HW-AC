  ...
  return (
    <Shell>
      <div className="flex justify-between flex-center mb-4">
        <h1 style={{ fontSize: "1.4rem", fontWeight: 600 }}>Production Cards</h1>
        <span className="text-dim text-sm">{data ? `${data.total} cards total` : ""}</span>
      </div>

      {/* Upload */}
      <div className="card mb-4">
        <div className="section-heading">New card — upload PDF</div>
        {uploading ? (
          <div className="processing-state">
            <div className="spinner" />
            <span>Uploading and starting extraction…</span>
          </div>
        ) : (
          <>
      ...
      <div className="filters">
        <input
          ...
          placeholder="Search… (file, line, tool, operator)"
